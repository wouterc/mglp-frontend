...
import { PlusCircle, AlertCircle, Edit, Loader2, X, MessageSquare, Copy, Check } from 'lucide-react';
...
function VirksomhederPage(): ReactElement {
    ...
    const debouncedAfdeling = useDebounce(filterAfdeling, 300);
    const debouncedGruppe = useDebounce(filterGruppe, 300);
            ...
            <div className="mb-4 py-4 px-2 bg-gray-50 rounded-lg border border-gray-200 flex">
                ...
                <div className="relative w-[15%] pr-4">
                    <input 
                        ...
                        onChange={(e: ChangeEvent<HTMLInputElement>) => setFilterAfdeling(e.target.value)}
                        className="w-full p-2 border rounded-md text-sm pr-7"
                    />
                    {filterAfdeling && (
                        <button onClick={() => setFilterAfdeling('')} className="absolute right-6 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600" title="Ryd felt">
                            <X size={16} />
                        </button>
                    )}
                </div>
                ...
                <div className="relative w-[10%] pr-4">
                    <select
                        value={filterGruppe}
                        onChange={(e: ChangeEvent<HTMLSelectElement>) => setFilterGruppe(e.target.value)}
                ...
                <table className="min-w-full bg-white">
                    <thead className="bg-gray-800 text-white text-sm">
                        <tr>
                            ...
                            <th className="text-left py-1 px-2 uppercase font-semibold w-[40%]">Email</th>
                            <th className="text-center py-1 px-2 uppercase font-semibold w-[50px]"></th>
                        </tr>
                    </thead>

...
import Button from '../components/ui/Button.tsx'; // Importer den nye knap
...
value={filters.aktivitet_nr} onChange={handleFilterChange} className="w-full p-2 border rounded-md text-sm"/>
         ...
         <div className="flex justify-between items-center mt-4">
            <div className="flex flex-wrap items-center gap-4 text-sm">
                <label className="flex items-center space-x-2 cursor-pointer">
                    <input type="checkbox" checked={visUdgaaede} onChange={() => dispatch({ type: 
 'SET_AKTIVITETSSKABELONER_STATE', payload: { aktivitetsskabelonerVisUdgaaede: !visUdgaaede } })} className="h-4 w-4 rounded border-gray-300"/>
 ...
 py-1 px-2 uppercase font-semibold w-[15%]">Aktiv.
Nr.</th>
      ...
      {nextPageUrl && (
           ...
           <div className="mt-4 text-center">
            ...
            <Button
                ...
                variant="secondary"
                className="mx-auto" // Bevarer centrering
            >
